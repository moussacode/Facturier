export class Datas {
    constructor(documentType, firstname, lastname, adress, country, town, zip, product, price, quantity, tva, date) {
    ...
    subtotal(price, quantity, tva) {
        const tvaPourcent = (tva / 100);
        const totalTva = price * tvaPourcent;
    ...
    htmlFormat() {
        ...
        <div class="row p-5">
    <div class="col-md-6">
        <h2 class="text-left">MOUSSACODE</h2>
    </div>
    <div class="col-md-6 text-right">
        ...
        <p class="font-weight-bold mb-1">Date <span class="font-weight-normal">${this.date.toLocaleDateString("fr-FR")}</span></p>
    </div>
</div>

<div class="row pb-5 p-5">
    <div class="col-sm-6 text-left">
        <p class="font-weight-bold">Entreprise MoussaCode</p>
        <p class="mb-1">Dakar,Yoff</p>
        <p>Senegal</p>
